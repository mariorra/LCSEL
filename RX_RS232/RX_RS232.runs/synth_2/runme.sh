...
HD_PWD='C:/Users/Engenieer/Documents/RX_RS232/RX_RS232.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log RX_RS232.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RX_RS232.tcl
